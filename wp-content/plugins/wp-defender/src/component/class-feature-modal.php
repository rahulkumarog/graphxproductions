...
class Feature_Modal extends Component {
	...
	public function get_dashboard_modals( $force_hide = false ): array {
		...
		$title        = esc_html__( 'Enhanced Security with Automatic IP Detection', 'wpdef' );
		$desc         = sprintf(
		...
		$button_title      = esc_html__( 'Go to Settings', 'wpdef' );
		...
		return array(
			...
			'welcome_modal'      => array(
				...
				'banner_alt'         => esc_html__( 'Modal for Automatic IP Detection', 'wpdef' ),
