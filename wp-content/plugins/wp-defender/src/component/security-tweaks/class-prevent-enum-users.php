...
class Prevent_Enum_Users extends Component implements Security_Key_Const_Interface {
	...
	public function to_array(): array {
		return array(
			'slug'             => $this->slug,
			'title'            => esc_html__( 'Prevent user enumeration', 'wpdef' ),
			'errorReason'      => esc_html__( 'User enumeration is currently allowed.', 'wpdef' ),
			...
			'bulk_title'       => esc_html__( 'Prevent user enumeration', 'wpdef' ),
		);
	}
